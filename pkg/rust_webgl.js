...
export class Renderer {
    ...
    /**
     * @param {string} mesh_str
     */
    load_model(mesh_str) {
        const ptr0 = passStringToWasm0(mesh_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderer_load_model(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    resize_context() {
        const ret = wasm.renderer_resize_context(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    set_bb_visible(visible) {
        const ret = wasm.renderer_set_bb_visible(this.__wbg_ptr, visible);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    change_shading(shading) {
        const ptr0 = passStringToWasm0(shading, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderer_change_shading(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} mouse_wheel
     */
    update(mouse_down, mouse_x, mouse_y, mouse_wheel) {
        const ret = wasm.renderer_update(this.__wbg_ptr, mouse_down, mouse_x, mouse_y, mouse_wheel);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rust_webgl_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
